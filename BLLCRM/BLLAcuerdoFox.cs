...
namespace BLLCRM
{
    public class BLLAcuerdoFox
    {
        ...
        /// <param name="ac"></param>
        /// <returns></returns>
        public string Acuerdo(List<AcuerdoFox> ListaAcuerdoFox)
        {
            int Contador = 0;
        ...
        /// <returns></returns>
        public string ActualizarAcuerdo(IEnumerable<AcuerdoFox> ac_fox_lista, IEnumerable<acuerdo_fox> AcuerdosCRM)
        {

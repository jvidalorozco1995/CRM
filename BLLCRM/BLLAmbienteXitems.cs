  ...
  public  class BLLAmbienteXitems
    {
        ...
        public int DeleteItemXambiente(int p)
        {
            try
            {
                ...
                UpdatePosicionItemXambienteEliminar(ctx);
        ...
        public int UpdatePosicionItemXambienteEliminar(ItemXambiente i)
        {
        ...
        public List<VistaAmbiente> ListItemXambiente(int id)
        {
            ...
            try
            {
                List<VistaAmbiente> lisb = bd.VistaAmbiente.OrderBy(t => t.Consecutivo).Where(t => t.Idambiente == id).ToList();

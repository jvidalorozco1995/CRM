function BLLAval() {
        ...
        $.ajax({
            ...
            success: function (result) {
                if (result.d != null) {
                        ...
                        BLLAval.CrearAmbientes(result.d, accion,idaval);
    ...
    BLLAval.CrearAmbientes = function (ambientes,accion,idaval) {
    ...
    function Actualizar(item,idaval) {

        var datos = "{ 'id':" + JSON.stringify(idaval) + " }";
        $.ajax({
            type: "POST", url: WsListaItemAval, data: datos,
            contentType: "application/json; charset=utf-8",
            dataType: 'json',
            ...
            success: function (result) {
                if (result.d != null) {
                    ...
                    BLLAval.CrearTablaItemsActualizar(item, result.d);
    ...
    BLLAval.CrearTablaItemsActualizar = function (item,items) {
      //  alert(item.Ambiente1);

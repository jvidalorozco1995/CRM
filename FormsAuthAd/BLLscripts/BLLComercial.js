...
function BLLComercial() {
    ...
    var Wsproyectos = "/ServiciosFox/WProyectos.asmx/LisbloProyec";///Listado de clientes
    var WsListProyec = "/ServiciosFox/WProyectos.asmx/LisProyectos";//Consulto Proyectos CRM
    var WsListInf = "/Servicios/WInformacion.asmx/Informacion";//Informacion
    var WsLcgestion = "/Servicios/WTareas.asmx/_lcgestion"; 
    var WsCancelarg = "/Servicios/WTareas.asmx/Cancelargestion";

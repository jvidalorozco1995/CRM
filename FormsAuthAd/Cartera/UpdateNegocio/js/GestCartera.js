...
var _admnegocio = (function () {
    ...
    var _addHandlers = function () {
       ...
       $(document).on('click', '#BtnSiguiente2', function () {
        ...
        $(document).on('click', '.CargarN', function () {
            ...
            inmueble = result[2];
            negocio = result[3];
            window.location.replace("Actualizarnegocio.aspx?cedula=" + persona + "&inmueble=" + inmueble + "&separacion=" + separacion + "&negocio=" + negocio);
    ...
    var Validar = function () {
        ...
        */
            ...
            _negocio._addHoja(Dtohoja(), inmueble, acuerdoP,acuerdoPG);
        }
    ...
    var Validar2 = function () {
        ...
        if ($('#TxtNombres').val().length < 1 || !letras.test($('#TxtNombres').val())) {
            ...
            _negocio._upddteHoja(Dtohoja2(), inmueble, acuerdoP,acuerdoPG);
        }

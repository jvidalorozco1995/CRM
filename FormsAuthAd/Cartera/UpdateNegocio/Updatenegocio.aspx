...
<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Updatenegocio.aspx.cs" Inherits="FormsAuthAd.Cartera.UpdateNegocio.Updatenegocio" %>
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-lg-12">
                                                        ...
                                                        <input class="control-label" id="Lvalor" type="text" />
                                                         <input class="control-label" id="idnegocio" type="text" />

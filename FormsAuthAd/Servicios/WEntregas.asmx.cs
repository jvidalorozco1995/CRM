    ...
    public class WEntregas : System.Web.Services.WebService
    {
        ...
        public int documento(string propietarioJ, string cedulaJ,string direccionJ, string manzanaJ,string propietario2J,string conjuntoJ)
        {
            try
            {
                ...
                dir.Text = direccionJ.Trim();
                Word.Range man = objdoc.Bookmarks.get_Item(ref manzana1).Range;
                man.Text = manzanaJ.Trim();
                Word.Range dir1 = objdoc.Bookmarks.get_Item(ref direccion2).Range;
                dir1.Text = direccionJ.Trim();
                Word.Range man1 = objdoc.Bookmarks.get_Item(ref manzana2).Range;
                man1.Text = manzanaJ.Trim();
                ...
                objdoc.Bookmarks.Add("direccion2", rango8);
                objdoc.Bookmarks.Add("manzana2", rango9);
                objdoc.Bookmarks.Add("fecha", rango5);
                objdoc.Bookmarks.Add("propietario2", rango6);
                objdoc.Bookmarks.Add("conjunto", rango7);
                objword.Visible = true;
                var destino = Path.Combine(Server.MapPath("~/Entrega/Actas/"), direccionJ.Trim() + manzanaJ.Trim() + ".pdf");

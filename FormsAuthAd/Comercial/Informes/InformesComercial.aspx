<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="InformesComercial.aspx.cs" Inherits="FormsAuthAd.Comercial.Informes.Informes" %>
...
<div class="row">
    <div class="col-lg-8 animated-panel zoomIn" style="animation-delay: 0.5s; -webkit-animation-delay: 0.5s;">
        <div class="hpanel">
     ...
     <div class="col-lg-4">
        ...
        <div class="col-lg-4 animated-panel zoomIn" style="animation-delay: 0.4s; -webkit-animation-delay: 0.4s;">
        <div class="hpanel">
            <div class="panel-heading">
                <div class="panel-tools">
                    <a class="showhide"><i class="fa fa-chevron-up"></i></a>
...
<div class="row">
    ...
    <script src="../../BLLscripts/BLLInfocomercial.js"></script>
    <script src="../../BLLscripts/BLLUtilidades.js"></script>
    <script src="js/Infocomercial.js"></script>
</asp:Content>

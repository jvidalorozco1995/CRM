...
namespace DAL
{
    ...
    public partial class clientes
    {
        ...
        [XmlIgnore] public virtual ICollection<historial_inmueble> historial_inmueble1 { get; set; }
        [XmlIgnore] public virtual ICollection<inmueble_separacion> inmueble_separacion { get; set; }
        [XmlIgnore] public virtual ICollection<inmueble_separacion> inmueble_separacion1 { get; set; }

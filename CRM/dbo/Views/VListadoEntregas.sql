...
SELECT        dbo.INMUEBLES_ENTREGAS.ID_INMUEBLES_ENTREGAS, dbo.INMUEBLES_ENTREGAS.ID_ENTREGA, dbo.INMUEBLES_ENTREGAS.REFERENCIA_INMUEBLE, inm.MZA, inm.INMUEBLE, 
                         ...
                         dbo.bloques.NOMBRE_BLO, dbo.proyectos.NOMBRE_PROYEC, dbo.proyectos.ID_PROYEC
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'VListadoEntregas';
...
Begin DesignProperties = 
   ...
   Begin CriteriaPane = 
      Begin ColumnWidths = 11
         ...
         Output = 720
         Append = 1400
         Ne', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'VListadoEntregas';

CREATE TABLE [dbo].[inmueble_separacion] (
    ...
    CONSTRAINT [FK__inmueble___CLIEN__1FD8A9E3] FOREIGN KEY ([CLIENTE]) REFERENCES [dbo].[clientes] ([CEDULA]),
    CONSTRAINT [FK__inmueble___CLIEN__33D4B598] FOREIGN KEY ([CLIENTE]) REFERENCES [dbo].[clientes] ([CEDULA]),
